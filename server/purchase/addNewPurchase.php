...
if($balance != 0) {
    ...
    $sql = "INSERT INTO purchase_credit_operations (credit_order, credit_date, voucher_no, invoice_no, total_amount, paid, balance) VALUES (1, '$invoiceDate', '$voucherNo', '$invoiceNo', '$grandTotal', '$paid', '$balance')";
    $conn->query($sql);
}
